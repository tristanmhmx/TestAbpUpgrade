...
public class TestUpgradeTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<TestUpgradeTenantDatabaseMigrationHandler> _logger;

    public TestUpgradeTenantDatabaseMigrationHandler(
        TestUpgradeEFCoreDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<TestUpgradeTenantDatabaseMigrationHandler> logger)
    {
